...
![A PowerShell object with different properties](/images/PS_Objects_1.png)
...
![The same PowerShell object as a response in the terminal](/images/PS_Objects_2.png)
...
![The documentation of the syntax of the cmdlet Set-PowerAppDlpErrorSettings](/images/PS_Objects_3.png)
...
![How to find your tenant ID](/images/PS_Objects_4.png)
...
![The script to change the Power APP DLP error settings](/images/PS_Objects_5.png)

Let’s make it a bit clearer and see, what’s what: 

![The script to change the Power APP DLP error settings but with markings to see what is what](/images/PS_Objects_6.png)
...
![the error message after we've changed it](/images/PS_Objects_7.png)
...
![The documentation of the syntax of the cmdlet Set-TenantSettings](/images/PS_Objects_8.png)
...
![The output from the cmdlet Get-TenantSettings](/images/PS_Objects_9.png)
...
```
![we've enabled the feedback survey](/images/PS_Objects_10.png)
...
![we've enabled the feedback survey](/images/PS_Objects_11.png)
